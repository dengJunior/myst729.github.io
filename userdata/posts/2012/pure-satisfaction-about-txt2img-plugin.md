...
最初开发这个插件仅仅是因为自己[挖了个坑跳进去](http://weibo.com/1408056531/y4d0TzGWX)。坑填完之后自然免不了[吼两声](#/blog/articles/2012/txt2img-publish-posts-to-weibo/)。过后就是有人建议我发布到 WordPress 官方插件目录，我觉得也不错，[就提交了](https://wordpress.org/plugins/txt2img/)。因为 WordPress 插件目录的代码是用 SVN 管理的，觉得不爽，所以又[放了一份到 GitHub](https://github.com/myst729/txt2img)。

![txt2img 下载数据](https://myst729.github.io/blog-images/2012/11/txt2img-stats.png)<!-- more -->
